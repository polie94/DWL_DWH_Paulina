...
engine = create_engine('postgresql://paulina:robby1234@laketexas1.cekhey4nqbaq.us-east-1.rds.amazonaws.com:5432/laketexas1')
...
for county in counties:
    ...
    # Set the index to ["county_name", "date"]
...
# Insert the historical weather data into the database using SQLAlchemy
session = Session()
